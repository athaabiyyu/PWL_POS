...
class UserController extends Controller
{
    ...
    public function destroy(string $id) {
        ...
        if(!$check) { // untuk mengecek data user dengan id yang dimaksud ada atau tidak
            return redirect('user')->with('erorr', 'Data user tidak ditemukan');
        }
        ...
        try {
            ...
            return redirect('user')->with('erorr', 'Data user gagal dihapus karena masih terdapat tabel lain yang terkait dengan tabel ini');
        }
    }
}
