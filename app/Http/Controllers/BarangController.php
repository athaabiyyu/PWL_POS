...
class BarangController extends Controller
{
    ...
    public function list(Request $request) {
        ...
        return DataTables::of($barang)->addIndexColumn() // menambahkan kolom index / no urut (default nama kolom: DT_RowIndex)
    ...
    public function destroy(string $id) {
        ...
        if(!$check) { // untuk mengecek data barang dengan id yang dimaksud ada atau tidak
            return redirect('barang')->with('erorr', 'Data barang tidak ditemukan');
        }
        ...
        try {
            ...
            return redirect('barang')->with('erorr', 'Data barang gagal dihapus karena masih terdapat tabel lain yang terkait dengan tabel ini');
        }
    }
}
